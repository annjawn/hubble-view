...
export interface ProjectUsage { project_path: string; sessions: number; tokens: number; cost_usd: number; last_active: string }
...
export interface Overview { range_days: number; totals: Totals; providers: ProviderUsage[]; timeline: TimelinePoint[]; projects: ProjectUsage[]; windows: UsageWindow[] }
